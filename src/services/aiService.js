 ...
 */
export async function askAI(userPrompt, weatherContext) {
    const systemPrompt = `คุณเป็นผู้เชี่ยวชาญด้านสภาพอากาศในประเทศไทย ตอบเป็นภาษาไทย กระชับ ชัดเจน ใช้ข้อมูลอากาศที่ให้มาเป็นหลัก
